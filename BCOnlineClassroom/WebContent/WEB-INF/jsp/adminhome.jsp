                ...
                <!-- MATERIALS CATEGORY -->
                        ...
                        <div id="collapsemfolder" class="panel-collapse collapse">
                                <div class="panel-body">
                                        ...
                                        <table border=1 cellpadding=4>
                                                <tr>
                                                        <th>Folder Name</th><th>Delete</th>
                                                </tr>
                ...
                <!-- MATERIALS FILE -->
                        ...
                        <div id="collapsemfile" class="panel-collapse collapse">
                                <div class="panel-body">
                                        <table border=1 cellpadding=4>
                                                <tr>
                                                        <th>Filename</th><th>Upload Date</th><th>Uploaded By</th><th>Subject</th><th>Category</th><th>Delete</th>
                                                </tr>
                                                <c:forEach var="matFile" items="${matFileList}">
                                                        <tr>
                                                                <td>${matFile.getFileName()}</td>
                                                                <td>${matFile.getUploadDate()}</td>
                                                                <td>${matFile.getUploader()}</td>
                                                                <td>${matFile.getSubjectName()}</td>
                                                                <td>${matFile.getFolderName()}</td>
                ...
                <!-- FORUM CATEGORY -->
                        ...
                        <div id="collapsefcategory" class="panel-collapse collapse">
                                <div class="panel-body">
                                        ...
                                        <table border=1 cellpadding=4>
                                                <tr>
                                                        <th>Category Name</th><th>Delete</th>
                                                </tr>
                ...
                <!-- FORUM COMMENT -->
                        ...
                        <div id="collapsefcomment" class="panel-collapse collapse">
                                <div class="panel-body">
                                        <table border=1 cellpadding=4>
                                                <tr>
                                                        <th>Content</th><th>Commented By</th><th>Delete</th>
                                                </tr>
                                                <c:forEach var="fComment" items="${fCommentList}">
                                                        <tr>
                                                                <td> <div id="comment">${fComment.getContent()}</div> </td>
                                                                <td> ${fComment.getCommenter()} </td>
